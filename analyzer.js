...
var sink = ["Function","eval","setTimeout","setInterval","execScript","document.write","document.writeln","innerHTML","href","src","html","after","append","appendTo","before","insertAfter","insertBefore","prepend","prependTo","replaceWith","parseHTML","jQuery","globalEval","appendChild","create","insert","setContent","setHTML"];
...
function analyzeArrays(var1, var2, var3, var4, var5, var6, var7, sData) {
...
function writeResult() {
  for (var i = 0; i < sourceData.length; i++) {
    if(ret[i]){
      log('[{'+ ret[i] +'}]' + 'XSSProbe Info: '+ getColorTextDesc(ret[i]) + '\n     Line: ' + (i+1) + '   Codes: ' + sourceData[i] + '[{/'+ ret[i] +'}]');
    }
  }
}
